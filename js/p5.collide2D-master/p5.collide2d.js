...
p5.prototype.collideRectCircleVector = function (r, sz, c, diameter) {
  return p5.prototype.collideRectCircle(
    r.x,
    r.y,
    sz.x,
    sz.y,
...
p5.prototype.collidePointRectVector = function (point, p1, sz) {
  return p5.prototype.collidePointRect(
    point.x,
    point.y,
    p1.x,
    p1.y,
...
p5.prototype.collidePointLineVector = function (point, p1, p2, buffer) {
  return p5.prototype.collidePointLine(
    point.x,
    point.y,
    p1.x,
    p1.y,
...
p5.prototype.collideLineCircleVector = function (p1, p2, c, diameter) {
  return p5.prototype.collideLineCircle(
    p1.x,
    p1.y,
    p2.x,
    p2.y,
...
p5.prototype.collideLineLineVector = function (
  p1,
  p2,
  p3,
  p4,
  ...
  return p5.prototype.collideLineLine(
    p1.x,
    p1.y,
    p2.x,
    p2.y,
...
p5.prototype.collideLineRectVector = function (
  p1,
  p2,
  r,
  rsz,
  ...
  return p5.prototype.collideLineRect(
    p1.x,
    p1.y,
    p2.x,
    p2.y,
...
p5.prototype.collideCirclePolyVector = function (
  c,
  diameter,
  vertices,
  interior
...
p5.prototype.collideRectPolyVector = function (r, rsz, vertices, interior) {
  return p5.prototype.collideRectPoly(
    r.x,
    r.y,
    rsz.x,
    rsz.y,
...
p5.prototype.collidePointTriangleVector = function (p, p1, p2, p3) {
  return p5.prototype.collidePointTriangle(
    p.x,
    p.y,
    p1.x,
    p1.y,
...
p5.prototype.collidePointArcVector = function (
  p1,
  a,
  arcRadius,
  arcHeading,
  ...
  return p5.prototype.collidePointArc(
    p1.x,
    p1.y,
    a.x,
    a.y,
